...
const expected_identifiers_types = [
    'AUTODETECT',
    'VIN',
    'GRZ',
    'STS',
...
const expected_items_count = expected_identifiers_types.length;
