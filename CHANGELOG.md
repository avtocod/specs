...
- Field with path `additional_info.vehicle.owner.phone_number` also fillable by `base.alt`, `base.alt.ext` [#109]
- Field with path `additional_info.vehicle.owner.geo.city` also fillable by `base.alt`, `base.alt.ext` [#109]
- Field with path `additional_info.vehicle.owner.geo.postal_code` also fillable by `base.alt`, `base.alt.ext` [#109]
- Field with path `additional_info.vehicle.owner.geo.region` also fillable by `base.alt`, `base.alt.ext` [#109]
...
- Field with path `identifiers.vehicle.pts` also fillable by `base.alt`, `base.alt.ext` [#109]
- Field with path `identifiers.vehicle.reg_num` also fillable by `base.alt`, `base.alt.ext` [#109]
- Field with path `identifiers.vehicle.sts` also fillable by `base.alt`, `base.alt.ext` [#109]
- Field with path `identifiers.vehicle.vin` also fillable by `base.alt`, `base.alt.ext` [#109]
...
- Field with path `registration_actions.items[].date.start` also fillable by `base.alt`, `base.alt.ext` [#109]
- Field with path `registration_actions.items[].geo` also fillable by `base.alt`, `base.alt.ext` [#109]
- Field with path `registration_actions.items[].identifiers.pts` also fillable by `base.alt`, `base.alt.ext` [#109]
- Field with path `registration_actions.items[].identifiers.sts` also fillable by `base.alt`, `base.alt.ext` [#109]
- Field with path `registration_actions.items[].owner.org.kpp` also fillable by `base.alt`, `base.alt.ext` [#109]
- Field with path `registration_actions.items[].owner.org.name` also fillable by `base.alt`, `base.alt.ext` [#109]
- Field with path `registration_actions.items[].owner.org.ogrn` also fillable by `base.alt`, `base.alt.ext` [#109]
- Field with path `registration_actions.items[].owner.org.tin` also fillable by `base.alt`, `base.alt.ext` [#109]
- Field with path `registration_actions.items[].owner.phone_number` also fillable by `base.alt`, `base.alt.ext` [#109]
- Field with path `registration_actions.items[].owner.type` also fillable by `base.alt`, `base.alt.ext` [#109]
...
- Field with path `tech_data.chassis.number` also fillable by `base.alt`, `base.alt.ext` [#109]
...
- Field with path `tech_data.engine.model.name` also fillable by `base.alt`, `base.alt.ext` [#109]
- Field with path `tech_data.engine.number` also fillable by `base.alt`, `base.alt.ext` [#109]
