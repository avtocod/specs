...
- Field with path `tech_data.brand.name.original` also fillable by `eaisto.base`
- Field with path `tech_data.model.name.original` also fillable by `eaisto.base`
- Field with path `tech_data.date.update` also fillable by `eaisto.base`
...
- Field with path `diagnostic_cards.items[].inspection.place` also fillable by `eaisto.base`
